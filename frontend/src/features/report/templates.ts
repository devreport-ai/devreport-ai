...
export interface ReportTemplate {
  ...
  galleryName: string
  description: string
  category: (typeof REPORT_TEMPLATE_CATEGORIES)[number]
...
export const REPORT_TEMPLATES: readonly ReportTemplate[] = [
  ...
  },
  {
    ...
    label: 'DOCS / REPORTS / IMPLEMENTATION.MD',
    chrome: true,
    toc: true,
  },
  {
  ...
  },
  {
    ...
    label: 'DEVREPORT-AI / PROJECT-REPORT',
    chrome: true,
  },
  {
    id: 'dark-tech',
