  ...
  return (
    <main className="mx-auto max-w-3xl space-y-8 p-6">
      <header className="space-y-2">
        ...
        <h1 className="text-3xl font-bold">개인정보처리방침·이용약관</h1>
      ...
      <section id="ai-data" className="space-y-2">
      ...
      <section id="privacy" className="space-y-2">
        <h2 className="text-xl font-semibold">개인정보처리방침 (초안)</h2>
        <p>
          서비스는 계정 이메일·이름, 프로젝트·파일·보고서·생성 작업·PDF 내보내기 상태를 기능 제공과
          장애 대응을 위해 처리합니다. 사용 이벤트에는 원본 파일·프롬프트·보고서 문서·개인정보를
          기록하지 않습니다.
        </p>
        ...
        <p>
          ...
          안에 복구할 수 있습니다. 계정 삭제 API와 공식 요청 채널은 베타 공개 전에 확정해야 합니다.
        </p>
      </section>

      <section id="terms" className="space-y-2">
        <h2 className="text-xl font-semibold">이용약관 (초안)</h2>
        <ul className="list-disc space-y-1 pl-5">
          <li>사용자는 업로드 자료를 처리할 권리와 필요한 동의를 확보해야 합니다.</li>
          <li>AI가 만든 결과는 사용자가 검토·수정한 뒤 사용해야 합니다.</li>
          <li>서비스를 타인의 권리를 침해하거나 보안 검사를 우회하는 용도로 사용할 수 없습니다.</li>
